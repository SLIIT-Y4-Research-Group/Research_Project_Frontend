...
class _HomeScreenState extends State<HomeScreen> {
        ...
        builder: (context) => MoodInputScreen(
          onGenerateStory: (moodProfile) async {
            ...
            await Navigator.pushReplacement(
              ...
              MaterialPageRoute(
                builder: (context) =>
                    SimpleGenerationScreen(moodProfile: moodProfile),
              ),
            );
  ...
  void _testDirectGeneration() {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => SimpleGenerationScreen(moodProfile: testProfile),
      ),
    );
  }
          ...
          : Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('images/storybg.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: TextStyle(
                            fontSize: 32,
                            fontWeight: FontWeight.bold,
                            color: Color.fromARGB(255, 113, 212, 131),
                          ),
                          ...
                          child: ListTile(
                            ...
                            onTap: () {
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) =>
                                      StoryDisplayScreen(story: story),
                                ),
                              );
                            },
                          ),
        ...
        children: [
          Container(
            ...
            child: Icon(
              icon,
              size: 24,
              color: const Color.fromARGB(255, 71, 223, 119),
            ),
          ),
          SizedBox(height: 8),
